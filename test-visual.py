...
def parser():
    ...
    parser.add_argument('--snapshot', type=str, default="/home/desktop/benchmark-code/SAM-USC12K-ViT-h-baseline+adapter-ARM-twoway/save/model-37", help='set the checkpoint name')
...
def test(Network):
    ...
    with torch.no_grad():
        ...
        for sample, name in tqdm(val_loader, desc="Processing"):
            ...
            coarse_map, Background_outputs, sod_outputs, cod_outputs = net(image, multimask_output=False,
                                                                           image_size=352)
            ...
            path = os.path.join(r"/home/desktop/benchmark-result/check/SAM-ARM", 'PASCAL-S')
